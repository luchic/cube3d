...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/04/17 17:14:52 by stefan            #+#    #+#             */
/*   Updated: 2026/04/17 17:14:53 by stefan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_parse_error	parse_texture(char **split, char **path,
	uint8_t bit, t_parse_ctx *ctx)
{
...
static t_parse_error	parse_color(char **split, int32_t color[3],
	uint8_t bit, t_parse_ctx *ctx)
{
	char	**rgb;
	int		i;
